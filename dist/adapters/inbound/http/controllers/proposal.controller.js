...
let ProposalController = class ProposalController {
    constructor(proposalWorkflow) {
        this.proposalWorkflow = proposalWorkflow;
    }
    async listProposals() {
...
], ProposalController.prototype, "listProposals", null);
__decorate([
    (0, common_1.Post)(),
...
exports.ProposalController = ProposalController = __decorate([
    ...
    __param(0, (0, common_1.Inject)('ProposalWorkflowPort')),
