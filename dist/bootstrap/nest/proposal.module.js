...
const assistant_controller_1 = require("../../adapters/inbound/http/controllers/assistant.controller");
const proposal_controller_1 = require("../../adapters/inbound/http/controllers/proposal.controller");
const proposal_service_1 = require("../../adapters/inbound/http/services/proposal.service");
    ...
    (0, common_1.Module)({
        ...
        providers: [
            ...
            chat_assistant_use_case_1.ChatAssistantUseCase,
            {
                ...
                useExisting: chat_assistant_use_case_1.ChatAssistantUseCase,
            },
            {
                provide: 'ProposalWorkflowPort',
                useExisting: proposal_service_1.ProposalService,
            },
            {
            ...
            outbox_event_publisher_1.OutboxEventPublisher,
            {
                ...
                inject: ['ProposalRepositoryPort', outbox_event_publisher_1.OutboxEventPublisher],
            },
            {
                ...
                inject: ['ProposalRepositoryPort', offer_eligibility_policy_1.OfferEligibilityPolicy, outbox_event_publisher_1.OutboxEventPublisher],
            },
            {
                ...
                inject: ['ProposalRepositoryPort', benefit_eligibility_policy_1.BenefitEligibilityPolicy, outbox_event_publisher_1.OutboxEventPublisher],
            },
            {
            ...
            },
            {
                ...
                useFactory: (repository, cardAccountPort, publisher) => new create_card_account_use_case_1.CreateCardAccountUseCase(repository, cardAccountPort, publisher),
                inject: ['ProposalRepositoryPort', 'CardAccountPort', outbox_event_publisher_1.OutboxEventPublisher],
            },
            {
                provide: activate_benefits_use_case_1.ActivateBenefitsUseCase,
                useFactory: (repository, benefitsPort, publisher) => new activate_benefits_use_case_1.ActivateBenefitsUseCase(repository, benefitsPort, publisher),
                inject: ['ProposalRepositoryPort', 'BenefitsPort', outbox_event_publisher_1.OutboxEventPublisher],
            },
            {
                ...
                inject: ['ProposalRepositoryPort', ai_assistant_service_1.AiAssistantService],
            },
            {
            ...
            {
                provide: list_proposals_use_case_1.ListProposalsUseCase,
                useFactory: (repository) => new list_proposals_use_case_1.ListProposalsUseCase(repository),
                inject: ['ProposalRepositoryPort'],
            },
        ],
    })
